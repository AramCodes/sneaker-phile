...
import img37 from "./images/jackets/product37.jpg";
import img38 from "./images/jackets/product38.jpg";
import img39 from "./images/jackets/product39.jpg";
import img40 from "./images/jackets/product40.jpg";
...
let all_product = [
  ...
  {
    id: 37,
    name: "Outter Wear Orange Black Jacket",
    price: 210.00,
    quantity: 0,
    inventory: 10,
    image: img37,
    category: "Jackets",
    description: "Crafted with Outter Wear's new thermal stitching, this lightweight jacke is perfect for the fall-to-winter transition. It is specially treated with a vintage-inspired wash and finished with the embroidered Outter wear logo."
  },
  {
    id: 38,
    name: "Hype Patches Jacket",
    price: 87.00,
    quantity: 0,
    inventory: 10,
    image: img38,
    category: "Jackets",
    description: "The HYPE. Men's Jacket is made from durable, water-resistant nylon with ripstop to keep you protected from the elements at all times. Featuring insulation to keep you warm and comfy in those chiller months. Finished with a fixed hood, full-zip embossed fastening and elasticated cuffs."
  },
  {
    id: 39,
    name: "Levi's Varsity Jacket",
    price: 90.00,
    quantity: 0,
    inventory: 10,
    image: img39,
    category: "Jackets",
    description: "Retro varsity style puffer jacket featuring a laydown collar with Levi's screen-print across back and a contrast front and back yoke"
  },
  {
    id: 40,
    name: "Supreme Army Fatigue Print",
    price: 157.00,
    quantity: 0,
    inventory: 10,
    image: img40,
    category: "Jackets",
    description: "Water resistant poly with camo woven graphic, down insulated quilted baffle and taffets lining."
  },
];
